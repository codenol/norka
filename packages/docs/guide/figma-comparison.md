...
Feature-by-feature comparison of Figma Design capabilities with Norka's current implementation status.
...
| MCP server | ✅ | @norka/mcp with stdio + HTTP transports; 87 core tools + 3 file management tools = 90 total |
