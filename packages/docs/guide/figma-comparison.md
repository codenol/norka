...
Feature-by-feature comparison of Figma Design capabilities with Beresta's current implementation status.
...
| MCP server | ✅ | @beresta/mcp with stdio + HTTP transports; 87 core tools + 3 file management tools = 90 total |
