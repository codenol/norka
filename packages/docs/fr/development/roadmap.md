...
**Livré :**
- @norka/core extrait dans packages/core/ (aucune dépendance DOM)
- @norka/cli avec opérations headless .fig (info, tree, find, export, analyze, eval)
...
- Serveur MCP (@norka/mcp) : stdio + HTTP, 87 outils core + 3 gestion de fichiers
