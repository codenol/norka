...
**Livré :**
- @beresta/core extrait dans packages/core/ (aucune dépendance DOM)
- @beresta/cli avec opérations headless .fig (info, tree, find, export, analyze, eval)
...
- Serveur MCP (@beresta/mcp) : stdio + HTTP, 87 outils core + 3 gestion de fichiers
