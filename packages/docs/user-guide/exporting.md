---
title: Exporting
description: Export images, SVG, and .fig subsets, and open .fig or .pen documents in Norka.
---
...
- **Copy as JSX** — copies the Norka JSX representation (compatible with `renderJsx()`)

## .fig File Operations

Norka uses the .fig format for full documents — the same binary format as Figma.
...
Files exported from Norka can be opened in Figma, and vice versa. The .fig format preserves all node types, properties, fills, strokes, effects, vector data, and layout settings.
