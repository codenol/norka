---
title: Context Menu
description: Right-click context menu actions in Norka — clipboard, z-order, grouping, components, and more.
---
...
- **Copy as JSX** — copies the Norka JSX representation for use with `renderJsx()`
