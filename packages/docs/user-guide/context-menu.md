---
title: Context Menu
description: Right-click context menu actions in Beresta — clipboard, z-order, grouping, components, and more.
---
...
- **Copy as JSX** — copies the Beresta JSX representation for use with `renderJsx()`
