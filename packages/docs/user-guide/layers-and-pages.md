---
title: Layers & Pages
description: Managing layers, pages, and the properties panel in Beresta.
---
...
- **Beresta JSX** — custom component tree compatible with `renderJsx()` for programmatic round-trip
