...
Porównanie funkcja po funkcji możliwości Figma Design z aktualnym stanem implementacji Beresta.
...
| Serwer MCP | ✅ | @beresta/mcp z transportami stdio + HTTP; 87 narzędzi core + 3 zarządzanie plikami = 90+ total |
