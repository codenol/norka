...
Porównanie funkcja po funkcji możliwości Figma Design z aktualnym stanem implementacji Norka.
...
| Serwer MCP | ✅ | @norka/mcp z transportami stdio + HTTP; 87 narzędzi core + 3 zarządzanie plikami = 90+ total |
