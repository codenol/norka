...
Confronto funzionalità per funzionalità delle capacità di Figma Design con lo stato di implementazione attuale di Norka.
...
| Server MCP | ✅ | @norka/mcp con trasporti stdio + HTTP; 87 strumenti core + 3 gestione file = 90+ total |
