...
**Consegnato:**
- @beresta/core estratto in packages/core/ (nessuna dipendenza DOM)
- @beresta/cli con operazioni headless .fig (info, tree, find, export, analyze, eval)
...
- Server MCP (@beresta/mcp): stdio + HTTP, 87 strumenti core + 3 gestione file
