...
**Consegnato:**
- @norka/core estratto in packages/core/ (nessuna dipendenza DOM)
- @norka/cli con operazioni headless .fig (info, tree, find, export, analyze, eval)
...
- Server MCP (@norka/mcp): stdio + HTTP, 87 strumenti core + 3 gestione file
