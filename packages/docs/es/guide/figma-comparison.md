...
Comparación característica por característica de las capacidades de Figma Design con el estado de implementación actual de Norka.
...
| Servidor MCP | ✅ | @norka/mcp con transportes stdio + HTTP; 87 herramientas core + 3 de gestión de archivos = 90+ total |
