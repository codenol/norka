...
description: Trazados vectoriales con curvas de Bézier en Beresta.
---
# Herramienta pluma
...
Los trazados en Beresta usan redes vectoriales — un modelo más flexible que las listas simples de puntos que soporta trazados ramificados y topología compleja. Es el mismo modelo que usa Figma, así que los trazados se mantienen perfectamente al abrir y guardar archivos .fig.
