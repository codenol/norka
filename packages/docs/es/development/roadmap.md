...
**Entregado:**
- @norka/core extraído a packages/core/ (sin dependencias DOM)
- @norka/cli con operaciones headless .fig (info, tree, find, export, analyze, eval)
...
- Servidor MCP (@norka/mcp): stdio + HTTP, 87 herramientas core + 3 de gestión de archivos
