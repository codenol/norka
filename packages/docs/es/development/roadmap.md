...
**Entregado:**
- @beresta/core extraído a packages/core/ (sin dependencias DOM)
- @beresta/cli con operaciones headless .fig (info, tree, find, export, analyze, eval)
...
- Servidor MCP (@beresta/mcp): stdio + HTTP, 87 herramientas core + 3 de gestión de archivos
