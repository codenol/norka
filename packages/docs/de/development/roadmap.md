...
**Geliefert:**
- @beresta/core extrahiert in packages/core/ (keine DOM-Abhängigkeiten)
- @beresta/cli mit headless .fig-Operationen (info, tree, find, export, analyze, node, pages, variables, eval)
...
- MCP-Server (@beresta/mcp): stdio + HTTP, 87 Core-Tools + 3 Dateiverwaltungs-Tools
