---
title: useI18n
description: Read localized Beresta UI messages and switch the active SDK locale.
---

# useI18n

`useI18n()` returns reactive translation groups plus locale controls for Beresta-powered editor shells.
