...
description: Управление слоями, страницами и панелью свойств в Norka.
---
...
- **Norka JSX** — дерево компонентов, совместимое с `renderJsx()` для программного двустороннего преобразования
