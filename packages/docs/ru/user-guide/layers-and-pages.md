...
description: Управление слоями, страницами и панелью свойств в Beresta.
---
...
- **Beresta JSX** — дерево компонентов, совместимое с `renderJsx()` для программного двустороннего преобразования
