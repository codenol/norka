...
- Идентичность приложения: иконка-карандаш, Cargo crate beresta, macOS Dock «Beresta»
...
**Реализовано:**
- @beresta/core извлечён в packages/core/ (без DOM-зависимостей, Bun workspace)
- @beresta/cli с headless-операциями над .fig (info, tree, find, export, analyze, node, pages, variables, eval), CPU-растеризация CanvasKit, вывод --json
...
- MCP-сервер (@beresta/mcp): stdio + HTTP (Hono + Streamable HTTP с сессиями), 87 core-инструментов + 3 инструмента управления файлами (90 всего), работает на Bun и Node.js
...
- Сайт документации VitePress на beresta.dev с i18n (6 языков)
