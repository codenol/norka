...
- Идентичность приложения: иконка-карандаш, Cargo crate norka, macOS Dock «Norka»
...
**Реализовано:**
- @norka/core извлечён в packages/core/ (без DOM-зависимостей, Bun workspace)
- @norka/cli с headless-операциями над .fig (info, tree, find, export, analyze, node, pages, variables, eval), CPU-растеризация CanvasKit, вывод --json
...
- MCP-сервер (@norka/mcp): stdio + HTTP (Hono + Streamable HTTP с сессиями), 87 core-инструментов + 3 инструмента управления файлами (90 всего), работает на Bun и Node.js
...
- Сайт документации VitePress на norka.dev с i18n (6 языков)
