...
Yoga от Meta обеспечивает вычисление макета CSS flexbox и grid через [форк](https://github.com/norka/yoga/tree/grid) с поддержкой CSS Grid. Тонкий адаптер сопоставляет имена свойств Figma с эквивалентами Yoga:
